              ...
              child: ListView(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        Text("Hello", style: TextStyle(fontSize: 30,color: Colors.white,fontWeight: FontWeight.bold,),),
                        SizedBox(height: 40),
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 80,),
            Text("Ready to learn something you didn't know \ntwo minutes ago?",style: TextStyle(color: Color(0xFF5e548e),fontSize: 15,fontWeight: FontWeight.bold),textAlign: TextAlign.center,),
            SizedBox(height: 30,),
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
              Text("Get Start ",style: TextStyle(color: Color(0xFF231942),fontSize: 26,fontWeight: FontWeight.bold),),
